    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          PopupMenuButton(
            itemBuilder: (context) => [
            PopupMenuItem(child: Text('ลบทั้งหมด'), onTap: (){
              showDialog(
                        context: context,
                        builder: (BuildContext) {
                          return AlertDialog(
                            ...
                            actions: [
                              ...
                              TextButton(
                                  onPressed: () {
                                    for (var c in context.read<ChatsProvider>().listChats) {
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: 
              List.generate(context.watch<ChatsProvider>().listChats.length, (index) {
                  return Column(
                    children: [
                      Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text( '${context.watch<ChatsProvider>().listChats[index].time.substring(0,5)} น.',
                                  style: TextStyle(
                              ...
                              isFile(context.watch<ChatsProvider>().listChats[index].message) == false?
                              InkWell(
                                  ...
                                  showDialog(
                                    ...
                                    builder: (context)=> Scaffold(
                                      ...
                                      appBar: AppBar(
                                        backgroundColor: Colors.black,
                                        leading: IconButton(
                                          icon: Icon(Icons.close, size: 40.sp, color: Colors.white,),
                                          onPressed: (){
                                            Navigator.pop(context);
                                          },
                                        ),
                                      ...
                                      body: Center(
                                        child: InteractiveViewer(
                                          child: SizedBox(
                                            ...
                                            width: double.infinity,
                                            child: Image.file(File(context.watch<ChatsProvider>().listChats[index].message)))),
                                      ),
                                    ));
                                },
                                onLongPress: (){
      ...
      bottomNavigationBar: Container(
        ...
        child: Row(
          ...
          children: [
            Padding(
              padding:
                  EdgeInsets.only(bottom: ScreenUtil().scaleHeight < 1 ? 4.h : 0),
              child: IconButton(
                icon: _isMessageEmpty? Icon(
                  Icons.camera_alt,
                  size: 32.sp,
            ...
            selectedImage == null
                ...
                : Stack(children: [
                    Card(
                      ...
                      child: Container(
                          constraints:
                              BoxConstraints(maxHeight: 160.h, maxWidth: 180.h),
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(10),
                          ),
                          child: Padding(
            ...
            IconButton(
              icon: Icon(
                ...
                color: Theme.of(context).colorScheme.primary,
                size: 34.sp,),
              onPressed: (_messageController.text.isNotEmpty || selectedImage != null)
                  ? () {
